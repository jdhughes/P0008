...
\lhead{}\chead{Hughes and White -- MODFLOW-2005 UPCG GPGPU Solver}\rhead{}
\lfoot{}\cfoot{\thepage}\rfoot{}

\title{Use of general purpose graphical processing units with MODFLOW-2005}
...
MODFLOW-2005 uses a cell-centered, finite-difference approximation of \textbf{equation~\ref{gwpde}} to solve for three-dimensional groundwater flow (Harbaugh 2005). Development of the finite-difference form of \textbf{equation~\ref{gwpde}} using the continuity equation for a cell results in
